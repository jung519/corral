...
const en: Dict = {
  ...
  'field.referenceRepo': 'Conventions / skills repo (optional)',
  'field.referenceRepo.repo': 'Reference repo (owner/name or https URL)',
  'field.referenceRepo.token': 'Access token (only if private)',
  'field.referenceRepo.hint': 'Cloned read-only beside your repos so the agent follows your conventions. Leave empty to skip.',
...
const ko: Dict = {
  ...
  'field.referenceRepo': '컨벤션 / 스킬 저장소 (선택)',
  'field.referenceRepo.repo': '레퍼런스 저장소 (owner/name 또는 https URL)',
  'field.referenceRepo.token': '액세스 토큰 (비공개일 때만)',
  'field.referenceRepo.hint': '내 저장소 옆에 읽기 전용으로 클론돼 에이전트가 컨벤션을 따릅니다. 안 쓰면 비워두세요.',
